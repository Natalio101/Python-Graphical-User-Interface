...
app.minsize(1300,400)
app.configure(bg = '#555555')


#conect or create connection with database
...
def add_info():
    conn = sqlite3.connect("PasswordSaver.db")
    c = conn.cursor()
    #Inseert information onto table
...
def show_info():
    ...
    for i in informations:
        my_list.insert(END,f'Website: {i[0]}')
...
#Labels
welcome = Label(app, text = "Welcome to Password Saver \n Please provide the information about the latest website that you've been sing up to", bg = '#555555')
welcome.grid(row= 0, column = 1, pady = 10, padx = 10, columnspan=2)

website_label = Label(app, text = "Website",bg = '#555555', fg = '#0abab5')
website_label.grid(row= 1, column = 0, pady = 10, padx=50)

email_label = Label(app, text = "Email or Username",bg = '#555555', fg = '#0abab5')
email_label.grid(row= 2, column = 0, pady = 10, padx=50)

password_label = Label(app, text = "Password",bg = '#555555', fg = '#0abab5')
password_label.grid(row= 3, column = 0, pady = 10, padx=50)

Iden_number = Label(app, text = "ID Number",bg = '#555555', fg = '#0abab5')
...
password_box = Entry(app,  width = 30)
...
#Buttons
#ADD Button
add_bnt = Button(app, text = "Add information",bg = '#555555', fg = '#0abab5' ,command = add_info)
add_bnt.grid(row = 4, column  = 0, columnspan=2)

#Show Button
show_btn = Button(app, text = "Show Records",bg = '#555555', command = show_info, fg = '#00ffff')
show_btn.grid(row = 1, column  = 2, columnspan=2)

#Delte button
delete_bnt = Button(app, text = 'Delete Information', bg = '#555555',command= delete_record, fg = '#00ffff')
delete_bnt.grid(row = 5, column = 2, columnspan=2)

#Update Button
save_bnt = Button(app, text = "Update", bg = '#555555',command = window_editor, fg = '#00ffff')
